...
const html = fs.readFileSync('publications/index.html', 'utf8');
...
check((html.match(/class="publication-discovery"/g) || []).length === 1, 'publication discovery appears exactly once');
