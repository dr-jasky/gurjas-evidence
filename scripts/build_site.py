...
def publish_sitewide_navigation(output:Path)->None:
    ...
    for target in sorted(output.rglob("*.html")):
        ...
        if relative in {"404.html","about/index.html","advisory/index.html","contact/index.html","ethics-charter/index.html","evidence/index.html","experience/index.html","faq/index.html"}:continue
